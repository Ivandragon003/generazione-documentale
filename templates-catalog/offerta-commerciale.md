...
*Offerta preparata da {{referente_commerciale}} — Valida fino al {{validita_offerta}}*  
*Per accettare questa offerta rispondere via email confermando il numero offerta {{numero_offerta}}*
