...
export const initialFieldValues: Record<string, string> = {
  ...
  scopoProgetto:
    "Digitalizzare il flusso di creazione, validazione e generazione PDF dei documenti di governance.",
  obiettiviProgetto:
    "Ridurre i tempi di compilazione del 40%, garantire auditabilità dei template e centralizzare le versioni.",
  budgetStimato: "€ 150.000",
  timeline: "Q2–Q4 2026",
  stakeholderPrincipali:
    "Direzione IT, PMO, Compliance, team sviluppo backend e frontend.",
};
