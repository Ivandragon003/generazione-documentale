...
const SECTIONS = [
  {
    id: "aa000001-aaaa-4aaa-8aaa-aaaaaaaaaaaa",
    categoryId: "11111111-1111-4111-8111-111111111111",
    name: "Presentazione aziendale",
    position: 0,
  },
  {
    id: "aa000002-aaaa-4aaa-8aaa-aaaaaaaaaaaa",
    categoryId: "11111111-1111-4111-8111-111111111111",
    name: "Offerte commerciali",
    position: 1,
  },
  {
  ...
  {
    id: "cc000001-cccc-4ccc-8ccc-cccccccccccc",
    categoryId: "33333333-3333-4333-8333-333333333333",
    name: "Avvio progetto",
    position: 0,
  },
  {
    id: "cc000002-cccc-4ccc-8ccc-cccccccccccc",
    categoryId: "33333333-3333-4333-8333-333333333333",
    name: "Gestione",
    position: 1,
  },
  {
    id: "cc000003-cccc-4ccc-8ccc-cccccccccccc",
    categoryId: "33333333-3333-4333-8333-333333333333",
    name: "Chiusura",
    position: 2,
  },
...
const f = (
  ...
  required = true,
  defaultValue = "",
): FieldDefinition => ({ name, label, type, required, defaultValue });
...
const FIELDS_CRONOPROGRAMMA: FieldDefinition[] = [
  ...
  f(
    ...
    "select",
    true,
    "pianificato,in corso,completato,sospeso",
  ),
  f("note", "Note", "textarea", false),
];
...
const FIELDS_SCHEDA_PROGETTO: FieldDefinition[] = [
  ...
  f(
    ...
    "select",
    true,
    "pianificazione,in corso,in attesa,completato,annullato",
  ),
...
const FIELDS_BRIEF_CREATIVO: FieldDefinition[] = [
  ...
  f(
    ...
    "select",
    false,
    "formale,informale,tecnico,creativo",
  ),
...
const FIELDS_PIANO_COMUNICAZIONE: FieldDefinition[] = [
  ...
  f(
    ...
    "select",
    false,
    "giornaliera,settimanale,mensile,al bisogno",
  ),
